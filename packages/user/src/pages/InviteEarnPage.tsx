    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Invite & Earn</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center">
              ...
              <div>
                <p className="text-sm font-medium text-gray-600">Valid Invites</p>
                <p className="text-2xl font-bold text-gray-900">{referralData?.validReferrals || 0}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">₹{referralData?.totalEarnings || 0}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Bonus Tiers */}
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">Bonus Tiers</h2>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    <div className={`w-8 h-8 rounded-full flex items-center justify-center mr-3 ${
                      tier.isCompleted ? 'bg-green-600' : 'bg-gray-400'
                    }`}>
                      {tier.isCompleted ? (
                  ...
                  <div className="text-right">
                    {tier.isCompleted ? (
                      ...
                      <span className="text-gray-500">
                        {tier.requiredReferrals - (referralData?.validReferrals || 0)} more needed
                      </span>
                    )}
                  </div>
                </div>
              ...
              {records.items.map((record: ReferralRecord) => (
                <div key={record.id} className="flex items-center justify-between py-3 border-b border-gray-200 last:border-b-0">
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="font-medium text-gray-900">{record.referredUser.username}</p>
                      <p className="text-sm text-gray-600">
