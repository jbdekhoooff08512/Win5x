...
import { BettingWarningProvider } from './contexts/BettingWarningContext';
      ...
      <BettingWarningProvider>
        <Layout>
          <Routes>
            ...
            <Route path="/invite-earn" element={<InviteEarnPage />} />
            <Route path="/promotions/invite-earn" element={<InviteEarnPage />} />
